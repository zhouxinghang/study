 ...
 *  @generated
 */
package com.zhouxinghang.study.thrift.tmodel;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2018-04-13")
public class LoginReq implements org.apache.thrift.TBase<LoginReq, LoginReq._Fields>, java.io.Serializable, Cloneable, Comparable<LoginReq> {
  ...
  public LoginReq setName(java.lang.String name) {
    this.name = name;
    return this;
  }
